...
def domain(url: str, url_protocol: str) -> Tuple[list[str], str, str, int, str, str]:
    """
...
def query_step(string: str, dic: dict) -> Tuple[str, dict[str, str]]:
    """
...
def path_query(url: str) -> Tuple[object, dict[str, str]]:
    """
